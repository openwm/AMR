...
from app.systems.wms.inventory.models import (
    MOVEMENT_TYPES,
    Location,
    Product,
    StockItem,
...
def available_qty(db: Session, *, product_id: int) -> int:
    """Sum of quantity across all AVAILABLE stock items for a product."""
    rows = db.execute(
